...
This is the second article in a series about Lisp; it assumes you read the
first one.
...
Since lists are so important there is a special syntax just for them:
...
Let's use our fresh knowledge to do something useful. Sometimes I want to
